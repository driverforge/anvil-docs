...
:::info Preview
The `driverforge` GitHub Action is in **preview**. This page documents the planned
...
| Input           | Description                                                                                                                       |
| --------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| `version`       | The `driverforge` release to install — a pinned version (e.g. `1.4.0`) or `latest` (the default). Pin it for reproducible builds.       |
...
| `anvil-path` | Absolute path to the installed `driverforge` binary.   |
